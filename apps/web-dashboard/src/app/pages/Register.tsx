...
import { Monitor, Mail, Lock, User, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <Link to="/" className="flex items-center justify-center gap-2 mb-8">
          ...
          <div className="flex flex-col leading-tight">
            <span className="font-bold text-base">Mobarez</span>
            <span className="font-medium text-sm text-slate-600 dark:text-slate-400">DisplayExtended</span>
          </div>
        </Link>
