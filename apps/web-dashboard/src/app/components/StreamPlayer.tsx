...
export function StreamPlayer({ stream, deviceName, onClose, onMouseMove, onMouseDown, onMouseUp, onWheel }: StreamPlayerProps) {
    ...
    return (
        <div className="relative group rounded-2xl overflow-hidden bg-black aspect-video shadow-2xl border border-slate-200/20 dark:border-slate-800/20">
            ...
            <div className="absolute inset-x-0 top-0 p-4 bg-gradient-to-b from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
            ...
            {/* Bottom Status */}
            <div className="absolute bottom-4 left-4 flex items-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
            ...
            <div className="absolute bottom-4 right-4 pointer-events-none">
                <Button size="icon" variant="ghost" className="text-white hover:bg-white/10 pointer-events-auto">
